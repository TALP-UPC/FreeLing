...
/** 
 * \file   fgen-ftemplates-dep1-v0-5.h
 * \brief  Declaration of FGenFTemplatesDep1v05
 * \author Xavier Carreras
 */

#ifndef DEP_FGENFTEMPLATESDEP1_V05_H
#define DEP_FGENFTEMPLATESDEP1_V05_H
...
namespace treeler {
  ...
  */
  ...
  static void PrintFeat(uint64_t u){
    char tmpidx[17];
    tmpidx[16] = '\0';
    feature_idx_sprint(tmpidx, u);
    cerr << tmpidx << endl;
  }
...
#include "treeler/dep/fgen-ftemplates-dep1-v0-5.tcc"
