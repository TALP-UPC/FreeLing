 ...
 public:
  ...
  config(int ac, char **av) {
    ...
    vis_cf.add_options()
      ...
      ("InputLevel",po::value<std::string>(&InputLv)->default_value("text"),"Input analysis level (text,token,splitted,morfo,sense,tagged)")
      ("OutputLevel",po::value<std::string>(&OutputLv)->default_value("tagged"),"Output analysis level (token,splitted,morfo,tagged,shallow,parsed,dep)")
